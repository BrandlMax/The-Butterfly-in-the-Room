...
Based on the example code from Apple:
https://developer.apple.com/documentation/vision/recognizing_objects_in_live_capture

Adapted by Maximilian Brandl for the purpose of "The Butterfly in the Room"
...
class VisionObjectRecognitionViewController: ViewController {
    ...
    func setupVision() -> NSError? {
        ...
        guard let modelURL = Bundle.main.url(forResource: "ButterflyPocMachiKoro - 300", withExtension: "mlmodelc") else {
