...
public class CameraManager : MonoBehaviour
{
    ...
    public void lookAtNewActor()
    {
        ...
        // Send data to UI
        // uIController.setCurrentActor(actorGenerator.actors[index].gameObject.getComponent<Actor>());
    }
    ...
    public void lookAtActor(int index)
    {
        ...
        // Send data to UI
        uIController.setCurrentActor(target.gameObject.GetComponent<Actor>());
    }
}